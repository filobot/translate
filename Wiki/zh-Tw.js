...
exports.MODULES = {
  ...
  VARIABLES_LIST: {
    ...
    USER_ID: "相關使用者的 ID",
    USER_NAME: "相關使用者的名稱",
    USER_DISCRIMINATOR: "相關使用者的編號",
    USER_TAG: "相關使用者的名稱和編號",
    USER_AVATAR_URL: "相關使用者的大頭貼 URL",
    SERVER_NAME: "伺服器名稱",
    SERVER_ID: "伺服器 ID",
    SERVER_ICON_URL: "伺服器圖示URL",
    SERVER_OWNER_MENTION: "伺服器擁有者的提及",
    SERVER_OWNER_ID: "伺服器擁有者的 ID",
    SERVER_MEMBER_COUNT: "伺服器成員數量",
    SERVER_INVITE_SPLASH_URL: "伺服器邀請頁面 URL",
    SERVER_BANNER_URL: "伺服器橫幅 URL"
  },
  ANTI_BAD_WORDS: {
