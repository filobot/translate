...
exports.PAGE_TITLES = {
  ...
  ANTI_SCAM_LINKS: "Anti Enlaces Estafadores",
...
exports.MODULES = {
  ...
  ACTION_LIST: {
    NOT_AVAILABLE_IN_SOME_MODULES: "Algunas de las sanciones descritas a continuación no se encuentran disponibles en todos los módulos",
    DELETE_THE_MESSAGE: "Eliminar el mensaje",
    WARN_THE_USER: "Advertir al usuario",
    KICK_THE_USER: "Expulsar al usuario",
    PERMANENTLY_MUTE_THE_USER: "Silenciar permanentemente al usuario",
    TEMPORARILY_MUTE_THE_USER: "Silenciar temporalmente al usuario",
    PERMANENTLY_BAN_THE_USER: "Prohibir permanentemente al usuario",
    TEMPORARILY_BAN_THE_USER: "Prohibir temporalmente al usuario",
    SOFTBAN_THE_USER: "Prohibir suavemente al usuario",
    SANCTION_DESCRIPTION: "Esta acción va a {{action}} al usuario en cuestión del servidor",
    MAX_TIME_ALLOWED: "El máximo tiempo permitido es {{time}}"
  },
  VARIABLE_LIST: {    
    ...
    USER_AVATAR: "ID del avatar del usuario en cuestión",
    USER_AVATAR_URL: "URL del avatar del usuario en cuestión",
    USER_REGISTRATION_DATE: "Fecha de registro del usuario en cuestión",
    USER_URL: "URL del usuario en cuestión",
    SERVER_NAME: "Nombre del servidor en cuestión",
    SERVER_ID: "ID del servidor en cuestión",
    SERVER_ICON: "ID del icono del servidor en cuestión",
    ...
    SERVER_INVITE_SPLASH: "ID del fondo de invitación del servidor en cuestión",
    SERVER_INVITE_SPLASH_URL: "URL del fondo de invitación del servidor en cuestión",
    SERVER_BANNER: "ID del cartel del servidor en cuestión",
    SERVER_BANNER_URL: "URL del cartel del servidor en cuestión",
    SERVER_VANITY_URL: "URL de vanidad del servidor en cuestión",
    SERVER_VANITY_CODE: "Código de vanidad del servidor en cuestión",
    SERVER_DESCRIPTION: "Descripción del servidor en cuestión",
    SERVER_DISCOVERY_SPLASH: "ID del fondo de descubrimiento del servidor en cuestión",
    SERVER_DISCOVERY_SPLASH_URL: "URL del fondo de descubrimiento del servidor en cuestión",
    SERVER_VERIFICATION_LEVEL: "Nivel de verificación del servidor en cuestión",
    SERVER_NSFW_LEVEL: "Nivel NSFW del servidor en cuestión",
    SERVER_AFK_TIMEOUT: "Tiempo para mover a un usuario al canal AFK",
    SERVER_AFK_CHANNEL: "Canal AFK del servidor en cuestión",
    SERVER_AFK_CHANNEL_ID: "ID del canal AFK del servidor en cuestión",
    SERVER_SYSTEM_CHANNEL: "Canal del sistema del servidor en cuestión",
    SERVER_SYSTEM_CHANNEL_ID: "ID del canal del sistema del servidor en cuestión",
    SERVER_RULES_CHANNEL: "Canal de reglas del servidor en cuestión",
    SERVER_RULES_CHANNEL_ID: "ID del canal de reglas del servidor en cuestión",
    SERVER_PUBLIC_UPDATES_CHANNEL: "Canal de actualizaciones públicas del servidor en cuestión",
    SERVER_PUBLIC_UPDATES_CHANNEL_ID: "ID del canal de actualizaciones públicas del servidor en cuestión",
    SERVER_PREMIUM_TIER: "Nivel premium del servidor en cuestión",
    SERVER_PREMIUM_SUBSCRIPTIONS: "Suscripciones premium del servidor en cuestión",
    SERVER_EXPLICIT_CONTENT_FILTER: "Filtro de contenido explícito del servidor en cuestión",
    SERVER_MFA_LEVEL: "Nivel MFA del servidor en cuestión",
    SERVER_CREATION_DATE: "Fecha de creación del servidor en cuestión",
    SERVER_LANGUAGE: "Idioma del servidor en cuestión",
  ...
  ANTI_REPEATED_TEXT: {
    DESCRIPTION: "Este módulo sancionará a aquellos usuarios que envíen texto repetido en un mismo mensaje"
  },
  ANTI_SPAM: {
  ...
  ANTI_SCAM_LINKS: {
    DESCRIPTION: "Este módulo sancionará a aquellos usuarios que envíen enlaces estafadores en sus mensajes",
    ENABLE_AGGRESIVE_FILTER: {
      TITLE: "Pasos para activar el filtro agresivo",
      SUBTITLE: "Activar el filtro agresivo",
      WARNING: "Activar el filtro agresivo puede provocar un mayor número de falsos positivos"
    },
    DISABLE_AGGRESIVE_FILTER: {
      TITLE: "Pasos para desactivar el filtro agresivo",
      SUBTITLE: "Desactivar el filtro agresivo"
